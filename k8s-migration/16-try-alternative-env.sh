...
kubectl delete pod -n ess -l app.kubernetes.io/name=your_livekit_api_key_here-authorisation-service
kubectl wait --for=condition=Ready pod -l app.kubernetes.io/name=your_livekit_api_key_here-authorisation-service -n ess --timeout=60s
