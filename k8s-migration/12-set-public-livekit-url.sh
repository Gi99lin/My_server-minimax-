...
echo "  ws://ess-your_livekit_api_key_here-sfu.ess.svc.cluster.local:7880"
echo ""
  ...
  template:
    spec:
      ...
      - name: your_livekit_api_key_here-authorisation-service
        env:
        - name: LIVEKIT_URL
          value: "ws://ess-your_livekit_api_key_here-sfu.ess.svc.cluster.local:7880"
...
echo "=========================================="
echo ""
kubectl get deployment -n ess ess-your_livekit_api_key_here-authorisation-service \
