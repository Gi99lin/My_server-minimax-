...
# Решение: Переключить на внутренний ClusterIP (ws://ess-your_livekit_api_key_here-sfu.ess.svc.cluster.local:7880)
...
echo ""
echo "Ожидается:"
echo "  LIVEKIT_URL: ws://ess-your_livekit_api_key_here-sfu.ess.svc.cluster.local:7880"
echo ""
