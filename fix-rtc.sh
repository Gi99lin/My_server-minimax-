...
kubectl delete svc -n ess ess-your_livekit_api_key_here-authorisation-service-nodeport --ignore-not-found
kubectl delete svc -n ess ess-your_livekit_api_key_here-sfu-nodeport-http --ignore-not-found
...
kubectl patch deployment -n ess ess-your_livekit_api_key_here-authorisation-service \
  --patch-file /tmp/livekit-external-url-patch.yaml

echo "Перезапуск..."
kubectl rollout restart deployment/ess-your_livekit_api_key_here-authorisation-service -n ess
kubectl rollout status deployment/ess-your_livekit_api_key_here-authorisation-service -n ess
